...
function ApplicationDashboardContent() {
          ...
          <div className="bg-white rounded-lg shadow-2xl border-2 border-gray-200 w-full max-w-md p-6">
              <div className="text-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900">
                  {lang === "rw" ? "Urupapuro rw'Ubwiyandikisho" :
                   lang === "fr" ? "Tableau de Bord des Applications" :
            ...
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-gray-600">
                  {lang === "rw" ? "Reba amakuru y'ubwiyandikisho bwacu" :
                   lang === "fr" ? "Visualisez les données de nos applications" :
                   "View our application analytics and insights"}
                </p>
              </div>
              <Button
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="p-6 border-b border-gray-200">
              <h2 className="text-xl font-semibold text-gray-900">
                {lang === "rw" ? "Amakuru y'Ubwiyandikisho" :
                 lang === "fr" ? "Données des Applications" :
                 "Application Analytics"}
              </h2>
              <p className="text-gray-600 mt-1">
                {lang === "rw" ? "Amakuru y'ubwiyandikisho n'ibikorwa byacu" :
                 lang === "fr" ? "Analyses des applications et performances" :
            ...
            <div className="p-6">
              <div className="relative w-full" style={{ paddingBottom: '62.25%' }}>
                <iframe
                  title="Ihuzo - Application - ver31 - Real"
                  width="100%"
                  height="100%"
                  src="https://app.powerbi.com/view?r=eyJrIjoiZTRhMDZmOTctZTgxYS00MTg1LWE4YzktMDgwZTBlNzc3ZDczIiwidCI6IjVkNzk4MGMzLTRhNDctNDM2Ni1iNmRkLWE1NjdlMjExOWVlYyJ9"
                  frameBorder="0"
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg shadow p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                {lang === "rw" ? "Ubwiyandikisho" :
                 lang === "fr" ? "Applications" :
                 "Applications"}
              </h3>
              <p className="text-gray-600 text-sm">
                {lang === "rw" ? "Reba ubwiyandikisho bwose n'ibikorwa byabyo" :
                 lang === "fr" ? "Consultez toutes les applications et leur statut" :
                 "Monitor all applications and their status"}
              </p>
            </div>
            
            <div className="bg-white rounded-lg shadow p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">
                {lang === "rw" ? "Abayandikishije" :
                 lang === "fr" ? "Candidats" :
                 "Candidates"}
              </h3>
              <p className="text-gray-600 text-sm">
                {lang === "rw" ? "Reba abayandikishije n'ibikorwa byabo" :
                 lang === "fr" ? "Analysez l'activité des candidats" :
                 "Track candidate engagement and activity"}
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <p className="text-gray-600 text-sm">
                {lang === "rw" ? "Reba icyerekezo cy'ubwiyandikisho" :
                 lang === "fr" ? "Surveillez les progrès des applications" :
                 "Monitor application progress and trends"}
              </p>
            </div>
          </div>
        </div>
