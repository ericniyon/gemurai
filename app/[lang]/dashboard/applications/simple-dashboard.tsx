...
export default function SimpleApplicationsDashboard() {
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">
              {lang === 'rw' ? 'Guhuza ubusabe' : 'Applications Dashboard'}
            </h1>
            <p className="text-muted-foreground">
              {lang === 'rw' 
                ? `Guhuza ubusabe ${meta?.totalApplications || 0} bose` 
                : `Managing ${meta?.totalApplications || 0} applications`
              }
            </p>
          </div>
          ...
          <CardContent>
            {applications.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-muted-foreground">
                  {lang === 'rw' ? 'Nta busabe buhagije' : 'No applications found'}
                </p>
              </div>
            ) : (
