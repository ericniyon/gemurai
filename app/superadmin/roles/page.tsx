    ...
    const mockAssignments: UserRoleAssignment[] = [
      {
        ...
        userEmail: "superadmin@Gemurai.rw",
      ...
      },
      {
        ...
        userId: "user2",
        userName: "Senior DCC",
        userEmail: "senior.dcc@Gemurai.rw",
        roleName: "DCC",
      ...
      },
      {
        id: "3",
        userId: "user3",
        userName: "Regular DCC",
        userEmail: "dcc@Gemurai.rw",
        roleName: "DCC",
        assignedAt: "2024-01-15",
        assignedBy: "Super Admin",
        isActive: true
      ...
      <div className="container mx-auto py-6">
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-gray-600">Loading role management data...</p>
          </div>
        </div>
      </div>
    )
      ...
      <div className="flex items-center justify-between">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Role Management</h1>
            ...
            Manage roles, permissions, and user assignments across the system
          </p>
            </div>
        </div>
        <div className="flex items-center gap-3">
            ...
            <Button size="sm" onClick={() => setIsCreateRoleOpen(true)} className="bg-blue-600 hover:bg-blue-700">
                        ...
                        >
                          ...
                          <TableCell className="px-6 py-4 text-center">
                            <div className="flex items-center justify-center gap-2">
                              ...
                              <span className="text-sm text-gray-600 font-medium">{assignment.assignedBy}</span>
                            </div>
                      </TableCell>
                          <TableCell className="px-6 py-4 text-center">
                            <div className="flex items-center justify-center gap-2">
...
function AssignRoleDialog({ open, onOpenChange, onSuccess }: {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Assigning role:', { userId: formData.userId, roleId: formData.roleId })
