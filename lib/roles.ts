...
export const ROLES: Role[] = [
  {
    ...
    permissions: ["*"], // All permissions including all MCC features
    level: 100,
  },
  {
    id: "ADMIN",
    ...
    permissions: [
      ...
      "reports.view",
      "reports.generate",
      // REMOVED: System-level permissions (users.create, users.edit, users.delete, admin.system, admin.users, admin.reports, admin.forms, finance.manage, wallet.manage)
    ],
  ...
  },
  {
    ...
    permissions: [
      "dashboard.view",
      "mcc.collections.view.own",
      "mcc.payments.view.own",
      "mcc.account.view.own",
      "mcc.ledger.view.own",
      "mcc.sales.view.own",
      "mcc.rentals.view.own",
      "profile.view",
      "profile.edit",
      "mcc.sms.receive",
    ],
  ...
  },
  {
    ...
    permissions: [
      ...
      "mcc.payments.process",
      "mcc.payments.manage",
      "mcc.payments.reconcile",
      "mcc.account.view",
      "mcc.account.manage",
      "mcc.ledger.view",
      "mcc.ledger.manage",
      "mcc.financial.view",
      "mcc.financial.manage",
      "mcc.reports.view",
      "mcc.reports.generate",
      "mcc.reports.financial",
      "reports.view",
      "reports.generate",
      "finance.view",
      "finance.manage",
